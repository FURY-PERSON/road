...
export type EditableNewsBlockText = Partial<Omit<NewsTextBlock, 'id' | 'paragraphs'>> & {localId: string, type: NewsBlockType, paragraphs: Array<EditableNewsBlockTextParagraph> }

export type EditableNewsBlockCode = Partial<Omit<NewsCodeBlock, 'id'>> & {localId: string, type: NewsBlockType, code: string }
