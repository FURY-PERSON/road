export { EditableNewsBlockContainer as EditableNewsBlockComponent } from './ui/EditableNewsBlock/EditableNewsBlock.container';
...
export { EditableNewsTextBlockDto } from './model/dto/EditableNewsTextBlockDto';
